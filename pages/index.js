  ...
  const [bubbles, setbubbles] = useState([
    {
      render: (
        <ChatText>
          <p>Hi 👋 my name is Muhammad Ramadhan Muna</p>
        </ChatText>
      ),
      show: false,
      delay: 1000,
    },
    {
      render: (
        <ChatText>
          <p>
            I am a Frontend Web Developer, people call me Rama sometimes Muna,
            i'm born in Indonesia (East Java) on November 28, 2001. I'm a
            student in Universitas Negeri Surabaya (UNESA)
          </p>
        </ChatText>
      ),
      show: false,
    ...
    <>
      ...
      <div className="fixed bottom-0 bg-white w-full border">
        <div className="container mx-auto px-6 py-2 flex items-center">
          ...
          {showActionButton ? (
            <a
              href="https://www.instagram.com/ramamunz/"
              target="_blank"
